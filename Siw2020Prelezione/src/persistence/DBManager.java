...
import persistence.dao.jdbc.CorsoDiLaureaDaoJDBC;
import persistence.dao.jdbc.DipartimentoDaoJDBC;
import persistence.dao.jdbc.ScuolaDaoJDBC;
...
//			dataSource=new DataSource("jdbc:postgresql://52.39.164.176:5432/xx","xx","p@xx");
			dataSource=new DataSource("jdbc:postgresql://localhost:5432/siw2020","postgres","postgres");
		} 
		catch (Exception e) {
